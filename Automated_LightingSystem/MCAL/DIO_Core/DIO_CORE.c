...
* \Description     : Write value on a specific pin
*                                                                             
...
* \Description     : Read the value from a specific pin
*
* \Sync\Async      : Synchronous
* \Reentrancy      : Non Reentrant
* \Parameters (in) : parameterName   Parameter Describtion
...
* \Description     : Toggele the pin value
*
* \Sync\Async      : Synchronous
* \Reentrancy      : Non Reentrant
* \Parameters (in) : parameterName   Parameter Describtion
...
/******************************************************************************
* \Syntax          : void DIO_WritePort(PORT_NUM PORT,uint8 Port_value)
* \Description     : Write value on a specific port
*
* \Sync\Async      : Synchronous
* \Reentrancy      : Non Reentrant
* \Parameters (in) : parameterName   Parameter Describtion
...
/******************************************************************************
* \Syntax          : void DIO_ReadPort(PORT_NUM PORT,uint8 *Port_value)
* \Description     : Read a value from a specific port
*
* \Sync\Async      : Synchronous
* \Reentrancy      : Non Reentrant
* \Parameters (in) : parameterName   Parameter Describtion
